...
(() => {
  ...
  const meta = [
    { title: "Monument in Sugar",    kicker: "Story",     cat: "story" },
    { title: "Gilded Occasion",      kicker: "Business",  cat: "business" },
    ...
    { title: "Knowledge is Sweet",   kicker: "Story",     cat: "story" },
    { title: "Count the Hours",      kicker: "Story",     cat: "story" },
    { title: "Unapologetically Ripe",kicker: "Detail",    cat: "rd" },
    { title: "Make It a Moment",     kicker: "Story",     cat: "business" },
    { title: "You Are My Flower",    kicker: "Story",     cat: "story" },
    { title: "Pure Celebration",     kicker: "Detail",    cat: "story" },
    { title: "Coffee & Roses",       kicker: "Story",     cat: "business" },
    { title: "Made with Intention",  kicker: "Vision",    cat: "vision" },
    { title: "In Free Fall",         kicker: "Detail",    cat: "rd" },
    { title: "Dark Matter",          kicker: "Detail",    cat: "rd" },
    { title: "Two Halves",           kicker: "Detail",    cat: "rd" },
    { title: "Red Sea",              kicker: "Vision",    cat: "vision" },
    { title: "Roots",                kicker: "Story",     cat: "story" },
    { title: "Almost Gone",          kicker: "Detail",    cat: "rd" },
    { title: "The Savoury Edit",     kicker: "Detail",    cat: "rd" },
    { title: "Green & Honest",       kicker: "Wellness",  cat: "all" },
    { title: "Citrus Light",         kicker: "Vision",    cat: "vision" },
  ];
